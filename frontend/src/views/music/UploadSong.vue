  ...
  <div class="upload-song-container">
    <el-card class="upload-song-card">
      ...
      <el-form ref="formRef" :model="formData" label-width="100px" class="upload-song-form">
        ...
        <el-form-item label="歌曲文件" prop="song_file" :rules="[{ required: true, message: '请选择歌曲文件', trigger: 'change' }]">
          <el-upload
        ...
        <el-form-item>
          <el-button type="primary" @click="handleSubmit" :loading="submitting">上传歌曲</el-button>
...
import { uploadSong } from '@/api/music'
